    ...
    return (
      <div className="control-pane">
        ...
        {this.state.matchGoal - this.state.gaugeValue > 0 ? (
          <div>
            ${this.state.matchGoal - this.state.gaugeValue} left for Walmart to
            match ${this.state.matchGoal} raised!
          </div>
        ) : (
        ...
        {this.state.gaugeValue >= this.state.donationGoal ? (
          ...
          <div>
            ${this.state.donationGoal - this.state.gaugeValue} left to reach our
            goal!
          </div>
        )}
